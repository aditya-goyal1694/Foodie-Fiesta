      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 mb-12">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-700">Experience the convenience of our Chat-à-la-Carte feature. Simply open the chat in the bottom right corner to place your order, ask about dishes, or get personalized recommendations!</p>
          </div>
        </div>
      </div>
      <main>
